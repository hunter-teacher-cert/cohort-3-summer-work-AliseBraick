public class TreeDriver{
  public static void main(String[]args){
    ...
    System.out.println(ten.evaluate()==2.0);
    ...
    */
    ...
    ExpressionTree e = new ExpressionTree('r',c,two);// testing the challenge
    ExpressionTree f = new ExpressionTree('^',c,ten);//testing the challenge
